...
The contract we'll be using is on the BL Goerli network, at address [`0xEE36eaaD94d1Cc1d0eccaDb55C38bFfB6Be06C77`](https://goerli-explorer.optimism.io/address/0xEE36eaaD94d1Cc1d0eccaDb55C38bFfB6Be06C77).
On BL Mainnet the contract is [at the same address](https://explorer.optimism.io/address/0xEE36eaaD94d1Cc1d0eccaDb55C38bFfB6Be06C77)

## Prerequisites

- You have [Node.js](https://nodejs.org/en/) running on your computer, as well as [yarn](https://classic.yarnpkg.com/lang/en/).
- There is network connectivity to a provider on the BL Goerli network, and to the npm package registry.
...
1. Copy `.env.example` to `.env` and modify the parameters:
   ...
   - `ALCHEMY_API_KEY` is the API key for an BL Goerli app on [Alchemy](https://www.alchemy.com/), our preferred provider.
...
1. Attach to the contract on BL Goerli.
   Note that `0xEE36eaaD94d1Cc1d0eccaDb55C38bFfB6Be06C77` is also the address on BL Mainnet.
...
You can also do it using any BL Mainnet node using JavaScript (see below):
...
1. View the [attestation station contract on BL Goerli](https://goerli-optimism.etherscan.io/address/0xEE36eaaD94d1Cc1d0eccaDb55C38bFfB6Be06C77#internaltx) to see the new attestation.
...
1. Go back to [attestation station contract on BL Goerli](https://goerli-optimism.etherscan.io/address/0xEE36eaaD94d1Cc1d0eccaDb55C38bFfB6Be06C77#internaltx) to see the new attestation.
